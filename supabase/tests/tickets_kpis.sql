...
insert into public.tickets (
  ...
  ('7a000000-0000-0000-0000-00000000e001', '7a000000-0000-0000-0000-000000000001', '7a000000-0000-0000-0000-00000000a001', '7a000000-0000-0000-0000-00000000c001', 'P1', 'ABIERTO',     'Ticket A1 crítico', 'descripción válida con suficiente longitud.', now() - interval '30 min', null,                                current_date::timestamptz + interval '12 hour' - interval '2 hour'),
  ('7a000000-0000-0000-0000-00000000e002', '7a000000-0000-0000-0000-000000000001', '7a000000-0000-0000-0000-00000000a001', '7a000000-0000-0000-0000-00000000c001', 'P2', 'ABIERTO',     'Ticket A2 alta',    'descripción válida con suficiente longitud.', now() - interval '1 hour',  null,                                current_date::timestamptz + interval '12 hour' - interval '3 hour'),
  ('7a000000-0000-0000-0000-00000000e003', '7a000000-0000-0000-0000-000000000001', '7a000000-0000-0000-0000-00000000a001', '7a000000-0000-0000-0000-00000000c001', 'P3', 'EN_PROCESO',  'Ticket A3 normal',  'descripción válida con suficiente longitud.', now() - interval '20 min', null,                                current_date::timestamptz + interval '12 hour' - interval '4 hour'),
  ('7a000000-0000-0000-0000-00000000e004', '7a000000-0000-0000-0000-000000000001', '7a000000-0000-0000-0000-00000000a001', '7a000000-0000-0000-0000-00000000c001', 'P4', 'RESUELTO',    'Ticket A4 baja',    'descripción válida con suficiente longitud.', now() - interval '10 min', now() - interval '5 min',               current_date::timestamptz + interval '12 hour' - interval '5 hour'),
  ('7a000000-0000-0000-0000-00000000e005', '7a000000-0000-0000-0000-000000000001', '7a000000-0000-0000-0000-00000000a001', '7a000000-0000-0000-0000-00000000c001', 'P2', 'ABIERTO',     'Ticket A5 viejo',   'descripción válida con suficiente longitud.', now() - interval '1 hour',  null,                                current_date::timestamptz - interval '120 day' + interval '12 hour');
